          ...
          <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
            ...
            <div className="text-center group">
              ...
              <p className="font-sans text-gray-600 leading-relaxed">
                Paste a contact's bio and briefly describe yourself.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="font-sans text-gray-600 leading-relaxed">
                Select your objective for the outreach.
              </p>
            </div>

            {/* Step 3: Receive Your Openers */}
            <div className="text-center group">
              <div className="relative mb-8">
                {/* Step Number Badge */}
                <div className="absolute -top-4 -left-4 bg-primary text-primary-foreground w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold z-20 shadow-lg">
              ...
              <h3 className="font-display font-bold text-xl mb-4 text-gray-900">
                Receive Your Openers
              </h3>
              <p className="font-sans text-gray-600 leading-relaxed">
                Instantly get three distinct, professionally crafted messages
                that communicate your value and objectives.
              </p>
            </div>
          </div>
        </div>
