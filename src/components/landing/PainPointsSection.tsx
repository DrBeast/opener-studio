  ...
  return <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">Sounds Familiar?</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {painPoints.map((point, index) => <div key={index} className="bg-white p-6 rounded-lg shadow-sm flex gap-4">
