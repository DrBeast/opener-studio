      ...
      <div className="container mx-auto px-4">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          <div className="space-y-6">
            ...
            <p className="text-xl text-gray-600">In today's tough market, getting seen is hard. ConnectorAI helps you build the meaningful connections and craft outreach that actually gets responses, without the awkwardness.</p>
          ...
          <div className="relative">
            <div className="rounded-2xl bg-gradient-to-r from-primary/10 to-primary/30 p-2">
              <div className="aspect-[4/3] overflow-hidden rounded-xl bg-white shadow-xl">
                <img src="https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="Professionals connecting and building relationships" className="object-cover w-full h-full" />
              </div>
            </div>
          </div>
        </div>
