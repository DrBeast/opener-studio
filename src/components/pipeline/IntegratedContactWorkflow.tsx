...
import { Info, Loader2, User, Building, ArrowRight, MessageCircle, UserPlus } from "lucide-react";
...
export const IntegratedContactWorkflow = ({ 
  ...
  const [createdContact, setCreatedContact] = useState<GeneratedContact | null>(null);
  ...
  return (
    <div className="space-y-6 bg-white rounded-lg border border-gray-200 p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-xl font-semibold">Create Contact & Generate Message</h2>
        <div className="flex-1 flex items-center justify-center gap-2 text-sm text-muted-foreground">
          <span className={`px-2 py-1 rounded text-xs ${!createdContact ? 'bg-primary text-white' : 'bg-gray-100'}`}>
            1. Create Contact
          </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className={`space-y-4 p-4 rounded-lg border-2 transition-all ${
          !createdContact ? 'border-primary/20 bg-primary/5' : 'border-gray-200 bg-gray-50/50'
        }`}>
            ...
            <>
              ...
              {generatedContact && (
                <AirtableCard className="border-green-200 bg-green-50">
                  <AirtableCardContent className="p-3">
                    <h4 className="font-medium mb-2 text-green-800 text-sm">Generated Contact</h4>
          ...
          {createdContact ? (
            ...
            <div className="flex items-center justify-center h-48 text-gray-400">
              <div className="text-center">
                ...
                <p className="text-sm">Create a contact first to generate a message</p>
              </div>
            </div>
          )}
        </div>
