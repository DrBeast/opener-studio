...
import { Target, Plus, X, ChevronsUpDown, Sparkles } from "lucide-react";
...
export function TargetsModal({
  ...
  useEffect(() => {
    const fetchExistingData = async () => {
      ...
      try {
        ...
        // Use the returned cleaned criteria
        if (cleanedCriteria) {
  ...
  // Common function to handle chip selections
