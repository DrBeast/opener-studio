...
import { StatusBadge } from "@/components/ui/airtable-ds/status-badge";
...
const FeedbackReview = () => {
  ...
  useEffect(() => {
    const fetchFeedback = async () => {
      try {
        console.log(
          "Fetching feedback data with user emails from user_profiles..."
        );
        ...
        const userIds =
          feedbackData?.map((item) => item.user_id).filter(Boolean) || [];
        ...
        const feedbackWithEmails: FeedbackEntry[] = (feedbackData || []).map(
          (item) => ({
            ...
            <div className="text-center space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-600">
                  Please wait while we gather user insights...
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm font-medium text-white">
                    {feedback.length > 0
                      ? format(new Date(feedback[0].created_at), "MMM dd")
                      : "N/A"}
                  </p>
                </div>
            ...
            {feedback.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-sm text-gray-400 mt-1">
                  Check back later for user insights
                </p>
              </div>
            ) : (
              <Table>
