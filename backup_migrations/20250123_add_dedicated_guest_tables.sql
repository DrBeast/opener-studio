...
CREATE TABLE guest_user_profiles (
...
CREATE TABLE guest_user_summaries (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  session_id TEXT NOT NULL,
  experience TEXT,
  education TEXT,
...
CREATE INDEX idx_guest_user_profiles_session_id ON guest_user_profiles(session_id);
CREATE INDEX idx_guest_user_summaries_session_id ON guest_user_summaries(session_id);
